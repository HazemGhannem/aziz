    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        ...
        <ul id="admin-page" class="collapse" aria-labelledby="Categorie-page" data-parent="#side-nav-accordion">
          ...
          <li> <a href="../admin/Modifieradmin.html">Modifier  Une catégories</a> </li>
          <li> <a href="../admin/Supprimeradmin.html">Supprimmer  Une catégories</a> </li>
          <li> <a href="../admin/AfficherCategorie.html"> Afficher les Catégories</a> </li>
